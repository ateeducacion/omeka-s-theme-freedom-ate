...
package:
	...
	rsync -av --exclude='tmpzip' --exclude='.git' --exclude='*.zip' --exclude='node_modules' --exclude='.DS_Store' --exclude='.github' --exclude='.agents' --exclude='.claude' --exclude='AGENTS.md' --exclude='CLAUDE.md' ./ tmpzip/freedom-ate/; \
